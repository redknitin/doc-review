		...
		[
			...
			'transitions' => [
				'rejected' => [
					...
					'users' => ['nospam@localhost.localdomain', 'sman@localhost.localdomain', 'oman@localhost.localdomain', 'gman@localhost.localdomain', 'pman@localhost.localdomain'],
					'conditions' => [
					],
				],
				'site-manager-approval-for-budgeted-material-purchase' => [
					...
					'users' => ['sman@localhost.localdomain', 'nospam@localhost.localdomain'],
					'conditions' => [
					],
				],
				'operation-manager-approval-for-budgeted-material-purchase' => [
					...
					'users' => ['oman@localhost.localdomain', 'nospam@localhost.localdomain'],
					'conditions' => [
				...
				'general-manager-approval-for-budgeted-material-purchase' => [
					...
					'from' => ['approved-by-site-manager'],
					'users' => ['gman@localhost.localdomain', 'nospam@localhost.localdomain'],
					'conditions' => [
				...
				'procurement-manager-approval-for-budgeted-material-purchase' => [
					...
					'users' => ['pman@localhost.localdomain', 'nospam@localhost.localdomain'],
					'conditions' => [
					],
				],
			],
